...
class Deezer extends erela_js_1.Plugin {
	...
	search (e, t) {
		...
		return __awaiter(this, void 0, void 0, function * () {
			const a = e.query || e;
			const [, o, l] = (r = a.match(REGEX)) !== null && void 0 !== r ? r : [];
			if (o in this.functions) {
				try {
					const e = this.functions[o];
					if (e) {
						const r = yield e(l); const i = o === 'track' ? 'TRACK_LOADED' : 'PLAYLIST_LOADED'; const n = ['playlist', 'album'].includes(o) ? r.name : null;
