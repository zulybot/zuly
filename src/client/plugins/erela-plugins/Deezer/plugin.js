...
const check = (options) => {
  if (typeof options.convertUnresolved !== 'undefined' &&
        typeof options.convertUnresolved !== 'boolean') { throw new TypeError('Deezer option "convertUnresolved" must be a boolean.') }
  if (typeof options.playlistLimit !== 'undefined' &&
        typeof options.playlistLimit !== 'number') { throw new TypeError('Deezer option "playlistLimit" must be a number.') }
  if (typeof options.albumLimit !== 'undefined' &&
        typeof options.albumLimit !== 'number') { throw new TypeError('Deezer option "albumLimit" must be a number.') }
}
